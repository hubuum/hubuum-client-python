...
class DiffTests(unittest.TestCase):
    ...
    def test_pull_request_uses_merge_base(self):
        ...
        self.assertEqual(policy.changed_paths(self.root, "pull_request", event), ["README.md"])
    ...
    def test_deleted_document_is_docs_only(self):
        ...
        head = self.commit()
        paths = policy.changed_paths(self.root, "push", {"before": self.base, "after": head})
    ...
    def test_merge_group_uses_group_diff(self):
        ...
        self.assertEqual(policy.changed_paths(self.root, "merge_group", event), ["README.md"])
    ...
    def test_failed_diff_cannot_report_docs_only(self):
        with self.assertRaises(subprocess.CalledProcessError):
            policy.changed_paths(self.root, "push", {"before": "missing", "after": self.base})
