...
class RestoreTimestamps(RequestModel):
    ...
    Hubuum v0.0.12 accepts timezone-free ISO 8601 values and interprets them as
...
class ImportGraph(RequestModel):
    ...
    complete v0.0.12 graph is accepted without exposing unstable or
...
class ExportTaskDetails(HubuumModel):
    """Export output state and v0.0.12 phase-duration measurements."""
...
class TaskDetails(HubuumModel):
    """Kind-specific task metadata exposed by Hubuum v0.0.12."""
