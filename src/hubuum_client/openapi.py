...
def _operation(operation_id: str) -> OperationSpec:
    try:
        ...
        raise ValueError(f"unknown Hubuum v0.0.15 operationId: {operation_id!r}") from None
...
class OpenAPIOperations:
    """Invoke every operation in Hubuum v0.0.15 by its stable OpenAPI operationId."""
...
class AsyncOpenAPIOperations:
    """Asynchronous operation-ID interface for the complete v0.0.15 contract."""
