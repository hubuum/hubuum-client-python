...
The public site is <https://hubuum.github.io/hubuum-client-python/>. It shares its theme,
...
Use Python 3.11 or newer, Bash, Git, and uv with this repository’s locked development dependencies:
...
uses its tagged prose and Python API source. Publishing a new release or updating development keeps older
