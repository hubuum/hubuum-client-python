...
- Hubuum server `v0.0.14` and its committed `docs/openapi.json` are the
...
The wrapper starts PostgreSQL and the immutable Hubuum v0.0.14 server image,
...
describe unit tests or an unpinned live run as v0.0.14 compatibility evidence.
