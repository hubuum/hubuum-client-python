...
- Hubuum server `v0.0.16` and its committed `docs/openapi.json` are the
...
The wrapper starts PostgreSQL and the immutable Hubuum v0.0.16 server image,
...
describe unit tests or an unpinned live run as v0.0.16 compatibility evidence.
